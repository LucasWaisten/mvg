...
export default function IdentitySection() {
    return (
        <section className="my-12 sm:my-16 lg:my-20 px-4">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8">
                    {/* Identity Section */}
                    <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-2xl border border-[#ffde59]/20 p-6 sm:p-8">
                        ...
                        <div className="space-y-4 sm:space-y-6 text-sm leading-relaxed text-[#2c1810]">
                            ...
                            <div className="relative py-4 sm:py-6">
                                <div className="absolute left-0 top-0 w-8 sm:w-12 h-0.5 sm:h-1 bg-[#ffde59]"></div>
                                <p className="italic text-[#8b7355] font-light pl-4 sm:pl-6 text-base sm:text-lg">
                                    &quot;No podemos callar lo que hemos visto y oído&quot;
                                </p>
                                <div className="absolute right-0 bottom-0 w-8 sm:w-12 h-0.5 sm:h-1 bg-[#ffde59]"></div>
                            </div>
                            <p className="text-base sm:text-lg leading-relaxed">
